...
|----------|--------|----------------------------------------------------------|
| 8x 01 00 |   √    | StandbyMode(off) 
| 8x 01 01 |   √    | AutoSleep(450min)
| 8x 01 02 |   1    | Unknown(83 41 02 02)
| 8x 01 0B |   √    | DevMode(on)
...
| 8x 01 44 |   2    | Unknown(8F 0F 41 44 40 00 0E 05 0E 0E 0E 5C 01 28 06 0E) > Changes very often, see ScratchPad-01-44 for an example output
| 8x 01 50 |   √    | Position(1000, 250, 64)
| 8x 01 59 |   √    | MotorStats(Unknown=3036676096, None=0)
| 8x 01 5A |   √    | MotorStats(Focus=3719100, Zoom=6702)
| 8x 01 5B |   √    | MotorStats(None=0, Iris=25470)
| 8x 01 5C |   √    | MotorStats(Pan=83655, Tilt=67011)
| 8x 01 5D |   √    | Clock 1 (t=4114222)
| 8x 01 5E |   √    | Clock 2 (t=3751092)
