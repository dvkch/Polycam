...
struct TesterCommand: CamerableCommand {
    ...
    func run(camera: Camera) throws {
        ...
        let testStates: [any PTZRequest] = [
            ...
            PTZRequestSetAutoExposure(enabled: true),
            PTZRequestSetAutoExposure(enabled: false),
            PTZRequestSetMireMode(enabled: true),
            ...
            PTZRequestSetInvertedMode(enabled: true),
            PTZRequestSetInvertedMode(enabled: false),
            PTZRequestSetAutoFocus(enabled: false),
            ...
            PTZRequestSetBacklightCompensation(enabled: true),
